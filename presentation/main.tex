...
\begin{block}{Wobbling Motion (WM)}
  \begin{itemize}
    ...
    \item In present, few wobblers are experimentally confirmed in the mass regions: $A\approx130,160,180$ $\rightarrow$ A list of all known wobblers will be available in my PhD thesis (Chapter 3). 
  \end{itemize}
\end{block}
